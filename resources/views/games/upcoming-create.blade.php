    ...
    <div class="bg-bf-cream rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-bf-navy">
            ...
            <div class="min-w-0 overflow-hidden">
                ...
                <input type="time" name="game_time" value="{{ old('game_time') }}" class="mt-1 w-full min-w-0 max-w-full box-border border border-gray-300 rounded-lg px-3 py-2 bg-white text-gray-800">
            </div>
